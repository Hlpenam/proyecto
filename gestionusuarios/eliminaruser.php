			...
			<div id="wrapper">
				...
				<!-- Main -->
					<div id="main">
						...
						<form  action="CRUD/Eliminados.php" method="POST">	
								...
								<!-- campos nombres-->
								 	<small id="cedulaHelp" class="form-text text-muted">Identificacion a Eliminar</small>
								 	<input type="text" class="form-control" id="example" aria-describedby="cedulaHelp" placeholder="Ver cedula" name="cedula" value="<?php echo $mostrar['cedula']; ?>" hidden>
