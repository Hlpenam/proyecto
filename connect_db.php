<?php // conexion a la base de datos por php
	$link =mysql_connect("localhost","root2","12345"); //conexion ip o localhost, y usuario en este caso no hay contraseña pero podemos ingresar usuarios con contraseña en las comillas vacias
