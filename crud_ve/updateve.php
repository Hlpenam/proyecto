						...
						<form  action="CRUD/editarDatos.php" method="POST">	
								...
								<?php
								 ...
								 <div class="form-group">
								 	...
								 	<!-- campos nombres-->
								 	<small id="placaHelp" class="form-text text-muted">placa a Actualizar</small>
								 	<input type="text" class="form-control" id="example" aria-describedby="placaHelp" placeholder="Ver cedula" name="placa" value="<?php echo $mostrar['placa']; ?>" readonly>
